...
The dataset has 229K rows and 21 columns initially. We filter the health outcome `high cholesterol` and 6 related factors (health-affecting behaviors) `No leisure-time physical activity`,`Sleep less than 7 hours`,`Binge drinking `,``,``,``.
### Part 2: NHANES
